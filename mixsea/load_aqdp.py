...
sys.path.append('/Users/Ashton/Downloads/Research 2022/mixsea');
#iimport aqdpturb

''' DATA IMPORTING AND PREPROCESSING FUNCTIONS '''
data_dir = '/Users/Ashton/Downloads/Research 2022/aquadata/'
...
class vehicle_motion:
    ...
    def get_orientation(self, index, func = None, unwrap=True ):
        # Get indicators of how much instrument shakes
        # using 3 variables: roll, pitch, and hdg
        variables = ['roll', 'pitch', 'hdg'];
        ...
        for jj in range(len(variables)):
            #perform diagnostics on all variables
            key = variables[jj];
            ...
            # --- if neceessary, apply function to the data
            if func is not None:
                data = func( data ); 
